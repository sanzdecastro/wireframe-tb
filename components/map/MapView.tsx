...
export function MapView({ drawMode, mapMode, projects, pendingCoords, selectedProjectId, onZoneComplete, onProjectClick, onSensorClick, heatmapVisible = false, cyclingLayerVisible = false, }: MapViewProps) {
